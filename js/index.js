//立即执行函数
// 为了防止变量污染，减少命名冲突，可以采取立即执行函数的写法，因为里面的变量都是局部变量
// 柱状图 1 模块
(function () {
    // 1.实例化对象
        ...
        series: [
            {
                ...
                // 修改柱子宽度
                barWidth: '40%',
                data: [200, 300, 900, 1500, 600,1200],
                itemStyle: {
                    //修改柱子圆角
                    barBorderRadius: 5
                }
        ...
        series: [
            {
                ...
                smooth: true,
                //tab栏切换事件
                // 点击 2022 需要把第一个对象里面的data ，换成 2022年对象里面的data[0]
            ...
            },
            {
                ...
                smooth: true,
                //tab栏切换事件
                // 点击 2023 需要把第二个对象里面的data ，换成 2023年对象里面的data[1]
        ...
        series: [
            {
                ...
                data: [
                    { value: 1, name: "20岁以下" },
                    { value: 4, name: "20-29岁以下" },
                    { value: 2, name: "30-39岁以下" },
                    { value: 2, name: "40-49岁以下" },
                    { value: 1, name: "50岁以上" },
                ],
                color: [
                    "#065aab",
